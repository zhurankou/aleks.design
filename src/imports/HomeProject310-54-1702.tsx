import svgPaths from "./svg-dxpnzjgjsx";
...
function Content() {
  return (
    <div className="content-stretch flex flex-col font-['Geologica:Bold',sans-serif] font-bold gap-[28px] items-start leading-[normal] not-italic relative shrink-0 text-[36px] w-[800px]" data-name="Content">
