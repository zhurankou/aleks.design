export default function Home() {
  return (
    <div className="bg-white not-italic relative size-full" data-name="Home">
      ...
      <p className="-translate-x-1/2 absolute font-['Geologica:Bold',sans-serif] font-bold leading-[normal] left-[863.5px] text-[36px] text-[rgba(0,0,0,0.3)] text-center top-[1001px] whitespace-nowrap" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Work
      </p>
    </div>
  );
