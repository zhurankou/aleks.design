...
import imgDoctor from '../assets/doctor-endoscopist.png';
...
export default function HomeProject3Slide6({ onHomeClick, onPreviousClick, onNextClick }: SlideProps) {
    ...
    >
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px relative w-full">
        ...
        >
          ...
          {/* Endoscopist illustration */}
          <div
            className="relative shrink-0 overflow-hidden"
            style={{
              width: 'clamp(180px, 30vw, 438px)',
