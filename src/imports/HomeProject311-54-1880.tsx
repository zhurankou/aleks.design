import svgPaths from "./svg-lrr8e290zv";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start justify-center relative shrink-0 text-[#0f0f0f]">
      <p className="relative shrink-0 w-[720px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        We partnered with UX Research to test key questions around prep quality, low-scoring segments, and reasons why the cecum wasn’t reached.
      </p>
      <p className="relative shrink-0 w-[720px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        My design partner built hi-fi BBPS prototypes while I created CIR designs
      </p>
    </div>
  );
}
...
export default function HomeProject() {
  return (
    <div className="bg-[#fdfcff] content-stretch flex flex-col items-start px-[120px] py-[80px] relative size-full" data-name="home-project-3-11">
      <Container />
    </div>
  );
}