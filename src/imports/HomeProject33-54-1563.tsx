import svgPaths from "./svg-f90xi6fk3x";
import imgAvatar from "figma:asset/76d0fb1ae5045a34be679b2dc62b6fbea21b101e.png";
import imgAdobeExpressFile3 from "figma:asset/72662ce3cbe9a03e58efa85fe1ff49c2a1dd5cdb.png";
...
function Content1() {
  return (
    <div className="content-stretch flex gap-[64px] items-center relative shrink-0" data-name="Content">
      <div className="h-[400px] relative shrink-0 w-[354px]" data-name="Adobe Express - file 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[110.82%] left-[-10.36%] max-w-none top-[-5.84%] w-[229.53%]" src={imgAdobeExpressFile3} />
        </div>
      </div>
      <Text />
    </div>
...
export default function HomeProject() {
  return (
    <div className="bg-[#ffc400] content-stretch flex flex-col items-start px-[120px] py-[80px] relative size-full" data-name="home-project-3-3">
      <Container />
    </div>
  );
}