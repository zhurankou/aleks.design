...
export default function HomeProject33({ onHomeClick, onPreviousClick, onNextClick }: SlideProps = {}) {
  return (
    <div
      ...
      <div className="flex flex-col flex-1 items-start justify-between w-full min-h-[calc(100vh-clamp(32px,12vh,160px))]">
        ...
        <div className="flex items-center justify-center w-full shrink-0">
          ...
          >
            ...
            >
              {/* BBPS colon image — dirty/unclean crop */}
              <div
                className="relative shrink-0"
                style={{ height: "clamp(240px, 50vh, 480px)", width: "clamp(190px, 30vw, 425px)" }}
              >
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                  <img
                    alt="BBPS colon illustration"
                    className="absolute max-w-none pointer-events-none"
                    style={{ height: "110.82%", left: "-10.36%", top: "-5.84%", width: "229.53%" }}
                    src={imgColon}
                  />
                </div>
              </div>
