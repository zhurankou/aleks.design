function Frame() {
  return (
    <div className="content-stretch flex gap-[16px] items-center justify-end relative shrink-0 text-right">
      <p className="relative shrink-0 text-[rgba(255,255,255,0.5)]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>{`@ 2026, with `}</p>
