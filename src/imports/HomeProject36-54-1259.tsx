import svgPaths from "./svg-xnoqzsmukf";
import imgAvatar from "figma:asset/76d0fb1ae5045a34be679b2dc62b6fbea21b101e.png";
import imgAdobeExpressFile2 from "figma:asset/c35e0311cb982032b2d9b6bab18c8a1f704b90ba.png";
  ...
  return (
    <div className="content-stretch flex flex-col font-['Geologica:Bold',sans-serif] font-bold gap-[24px] items-start leading-[normal] not-italic relative shrink-0 text-[36px] w-[720px]" data-name="Text">
      <p className="relative shrink-0 text-[#0f0f0f] w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Endoscopist–Physician performing diagnostic and therapeutic endoscopy procedures.
      </p>
      <p className="indent-[calc(1px_*_(0px-0.45*36px))] relative shrink-0 text-[#fdfcff] w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>{`"I need efficient tools for real-time procedure documentation, image capture, and seamless patient data access during endoscopies."`}</p>
    </div>
  );
}
...
function Content1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Content">
      <Text />
      <div className="h-[480px] relative shrink-0 w-[438px]" data-name="Adobe Express - file 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[121.49%] left-[-11.71%] max-w-none top-[-11.21%] w-[244.06%]" src={imgAdobeExpressFile2} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center pl-[40px] relative w-full">
          <Content1 />
        </div>
      </div>
    </div>
...
export default function HomeProject() {
  return (
    <div className="bg-[#ffc400] content-stretch flex flex-col items-start px-[120px] py-[80px] relative size-full" data-name="home-project-3-6">
      <Container />
    </div>
  );
}