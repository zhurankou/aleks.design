...
import imgContent from '../assets/p3-feedback2.png';
...
export default function HomeProject3Slide12({ onHomeClick, onPreviousClick, onNextClick }: SlideProps) {
  ...
  return (
    ...
    >
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px relative w-full">
        ...
        {/* Bottom nav — Previous | Feedback | Next */}
        <div
