...
export default function HomeProject3Slide8({ onHomeClick, onPreviousClick, onNextClick }: SlideProps) {
        ...
        >
          ...
          <div className="content-stretch flex items-start justify-center relative shrink-0 w-full">
            ...
            >
              ...
              >
                My design partner and I worked with UX Research on testing, low-fi prototypes, interviews, and notes.
              </p>
            </div>
          </div>
        </div>
