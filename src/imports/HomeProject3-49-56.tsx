import svgPaths from "./svg-h9wox8aqvu";
...
export default function HomeProject() {
  return (
    <div className="bg-[#ffc400] content-stretch flex flex-col items-start p-[80px] relative size-full" data-name="home-project-3">
      <Container />
    </div>
  );
}