import svgPaths from "./svg-f7gyq4ez88";
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start justify-center min-h-px min-w-px not-italic relative text-[#0f0f0f]" data-name="Text">
...
function Images() {
  return (
    <div className="h-[602px] relative shrink-0 w-[507px]" data-name="Images">
      <div className="absolute h-[360px] left-[134px] rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-0 w-[373px]" data-name="Procedures - Cecal Intubation Rate-1 1">
      ...
      <div className="absolute h-[360px] left-[67px] rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-[121px] w-[373px]" data-name="Procedures - Cecal Intubation Rate 1">
      ...
      <div className="absolute h-[360px] left-0 rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-[242px] w-[373px]" data-name="Procedures - Bowel Preparation 1">
