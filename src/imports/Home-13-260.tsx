...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[160px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <div className="font-['Geologica:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[64px] text-black w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
  ...
  return (
    <div className="aspect-[1728/1139] bg-white relative shrink-0 w-full" data-name="home-landing">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[80px] pt-[454px] px-[160px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
...
function Container1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between leading-[normal] min-h-px min-w-px not-italic relative w-full" data-name="Container">
      <p className="font-['Geologica:SemiBold',sans-serif] font-semibold relative shrink-0 text-[64px] text-white w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        OneDrive
        <br aria-hidden="true" />
        Sharing Redesign
      </p>
...
function Container2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px not-italic relative w-full" data-name="Container">
      <div className="font-['Geologica:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[64px] text-white w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
...
function Container3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px not-italic relative w-full" data-name="Container">
      <div className="font-['Geologica:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[#0f0f0f] text-[64px] w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
...
function Container4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between leading-[normal] min-h-px min-w-px not-italic relative w-full" data-name="Container">
      <p className="font-['Geologica:SemiBold',sans-serif] font-semibold relative shrink-0 text-[64px] text-white w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        {`Let’s `}
        <br aria-hidden="true" />
        Get in Touch!
      </p>
