import svgPaths from "./svg-qut6r6ahoi";
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start justify-center not-italic pr-[120px] relative text-[#0f0f0f] w-full">
...
function Images() {
  return (
    <div className="h-[642px] relative shrink-0 w-[548px]" data-name="Images">
      <div className="absolute h-[400px] left-[134px] rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-0 w-[414px]" data-name="Procedures - Cecal Intubation Rate-1 1">
      ...
      <div className="absolute h-[400px] left-[67px] rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-[121px] w-[414px]" data-name="Procedures - Cecal Intubation Rate 1">
      ...
      <div className="absolute h-[400px] left-0 rounded-[12px] shadow-[0px_10px_25px_5px_rgba(0,0,0,0.1)] top-[242px] w-[414px]" data-name="Procedures - Bowel Preparation 1">
