import svgPaths from "./svg-89aw0t21rd";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col font-['Geologica:Bold',sans-serif] font-bold gap-[87px] items-start leading-[normal] not-italic relative shrink-0 text-[36px] w-full" data-name="Text">
      <Row />
      <Row1 />
      <Row2 />
    </div>
