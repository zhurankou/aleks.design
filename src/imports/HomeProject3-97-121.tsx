...
import imgColon from '../assets/colon-cir.png';
...
export default function HomeProject3Slide4({ onHomeClick, onPreviousClick, onNextClick }: SlideProps) {
    ...
    >
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-between min-h-px min-w-px relative w-full">
        ...
        >
          ...
          >
            <img
              alt="Cecal Intubation Rate illustration"
