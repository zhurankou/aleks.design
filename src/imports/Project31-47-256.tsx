import svgPaths from "./svg-61yp1ar5ng";
...
function Row() {
  return (
    <div className="content-stretch flex gap-[40px] items-start relative shrink-0 w-full" data-name="Row">
      <p className="flex-[1_0_0] min-h-px min-w-px relative text-[#ffc400] text-right" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
        Objective
      </p>
      <p className="relative shrink-0 text-[#0f0f0f] w-[880px]" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>
...
function Text() {
  return (
    <div className="content-stretch flex flex-col font-['Geologica:Bold',sans-serif] font-bold gap-[64px] items-start leading-[normal] not-italic relative shrink-0 text-[36px] w-full" data-name="Text">
      <Row />
      <Row1 />
      <Row2 />
    </div>
...
export default function Project() {
  return (
    <div className="bg-[#fdfcff] content-stretch flex flex-col items-start px-[160px] py-[120px] relative size-full" data-name="project-3-1">
      <Container />
    </div>
  );
}