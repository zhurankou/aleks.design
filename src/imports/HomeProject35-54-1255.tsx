import svgPaths from "./svg-wip3coa4lr";
import imgAvatar from "figma:asset/76d0fb1ae5045a34be679b2dc62b6fbea21b101e.png";
import imgAdobeExpressFile3 from "figma:asset/c35e0311cb982032b2d9b6bab18c8a1f704b90ba.png";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col font-['Geologica:Bold',sans-serif] font-bold gap-[24px] items-start leading-[normal] not-italic relative shrink-0 text-[36px] w-[720px]" data-name="Text">
      ...
      <p className="indent-[calc(1px_*_(0px-0.45*36px))] relative shrink-0 text-[#fdfcff] w-full" style={{ fontVariationSettings: "'CRSV' 0, 'SHRP' 0" }}>{`"I need oversight dashboards for service metrics, staff scheduling, quality audits, and compliance training tracking."`}</p>
    </div>
  );
}
...
function Content1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Content">
      <Text />
      <div className="h-[480px] relative shrink-0 w-[445px]" data-name="Adobe Express - file 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[121.49%] left-[-127.13%] max-w-none top-[-11.21%] w-[240.1%]" src={imgAdobeExpressFile3} />
        </div>
      </div>
    </div>
  );
...
export default function HomeProject() {
  return (
    <div className="bg-[#ffc400] content-stretch flex flex-col items-start px-[120px] py-[80px] relative size-full" data-name="home-project-3-5">
      <Container />
    </div>
  );
}