C25.7643 25.0572 25.7138 25.3596 25.6987 25.6875C25.695 25.7804 25.695 25.7804 25.6926 25.8704C25.6872 26.0831 25.684 26.1691 25.6734 26.3246C25.6622 26.488 25.6654 26.662 25.6808 26.8457C25.7029 27.1088 25.6808 27.4683 25.6808 27.4683C25.6808 27.4683 25.4117 27.447 25.1116 27.4528C24.7449 27.46 24.44 27.4494 24.2293 27.4209C23.9253 27.3793 23.1043 26.5081 22.684 25.8294C22.0416 24.7906 20.4821 24.841 19.8429 25.7584C19.2663 26.5907 18.441 27.4114 18.196 27.4375C17.3999 27.5224 16.167 27.5321 13.793 27.4974C13.5661 27.4941 13.5661 27.4941 13.3393 27.4907C12.4278 27.4769 12.4628 27.6074 12.4815 27.4683C12.5348 27.0713 12.5287 27.1457 12.4815 26.7487C12.4023 26.0831 12.1601 25.5403 11.6553 25.1798C11.3942 24.9918 11.0818 24.746 10.4545 24.2407C9.73783 23.6634 9.51338 23.485 9.23677 23.2788L7.53382 21.6736C7.34689 21.4709 5.70607 19.0894 4.95701 18.1676C4.66562 17.8098 4.55662 17.6936 3.43829 16.525ZM23.6465 16.5318L23.6465 22.7655C23.6465 23.6666 25.2404 23.6666 25.2404 22.7655L25.2404 16.5318C25.2404 15.6307 23.6465 15.6307 23.6465 16.5318ZM19.3289 16.5307L19.3629 22.7897C19.3678 23.6908 20.9617 23.6845 20.9568 22.7835L20.9228 16.5245C20.9179 15.6234 19.324 15.6296 19.3289 16.5307ZM16.7593 22.7547L16.7146 16.5804C16.7081 15.6793 15.1142 15.6876 15.1207 16.5887L15.1654 22.763C15.1719 23.664 16.7658 23.6557 16.7593 22.7547Z"
      fill="white"
    />
  </svg>
);
...
function StageCursor({
  ...
  const animation = enter
    ...
    : click
      ? 'oly-lofi-cursor-click 0.55s cubic-bezier(0.45, 0, 0.25, 1)'
      : undefined;
  return (
    <div
      aria-hidden
      style={{
        ...
        // Anchor scale/click squeeze at the fingertip (svg-local ~10,2) so the
        // cursor stays glued to its target as it grows and taps.
        transformOrigin: '10px 2px',
        // Cursor stays at full opacity through the click pulse (matches
        // square 5) — the squeeze + rebound reads cleanly without the
        // cursor fading underneath it. Fades out only when the phase
        // moves off enter/travel/click.
        opacity: showing ? 1 : 0,
        // Opacity transition tuned to match the overlay + modal fade-in
        // (0.5 s spring-out) so the cursor's fade-out, the dimmer's fade-in
        // and the modal's reveal all start AND finish on the same beat.
        transition:
          'opacity 0.5s cubic-bezier(0.22, 1, 0.36, 1), left 0.8s cubic-bezier(0.32, 0.72, 0, 1), top 0.8s cubic-bezier(0.32, 0.72, 0, 1)',
        animation,
        pointerEvents: 'none',
        zIndex: 10,
      }}
    >
      {/* Counter-scale so the on-screen size matches square 5's cursor. The
          chart wrapper has `perspective: 900px` on its parent and
          `translateZ(60px)` here, which enlarges anything inside by
          900 / (900 − 60) ≈ 1.071×. Scale 1/1.071 ≈ 0.933 cancels that out
          so the cursor renders at native 32 × 29 in screen pixels — same as
          PdrTabCursor in square 5. Origin pinned to the fingertip so the
          click target doesn't shift. */}
      <div style={{ transform: 'scale(0.933)', transformOrigin: '10px 2px' }}>
        {HAND_CURSOR}
      </div>
    </div>
  );
...
export function LoFiPolypsCharts() {
  ...
  useEffect(() => {
    ...
    const cycle = () => {
      ...
      timers.push(window.setTimeout(() => setPhase('cursor1-click'),  2050));
      timers.push(window.setTimeout(() => setPhase('modal1-show'),    2250));
      // Swap to flow2.1 — 1.5 s 3D depth interchange. The modal+overlay stay
      // up until this beat, then fade out (showModal1 → false) AS the swap
      // begins, so the overlay removal is timed with the charts swapping.
  ...
  // Jan's value point grows slightly once that flow's cursor lands on it.
  // Jan is index 1 on each chart's PDR line. `hoveredIndex` flips on at
  // travel-start, but the cursor's travel easing (cubic-bezier(0.32,0.72,0,1),
  // 0.8s) is a strong ease-out that covers ~95% of the distance in its first
  // ~400ms, so the cursor *visually* arrives at ~400ms. We hold the dot at
  // normal size until then via a transition-delay, then pop it quickly — so
  // it grows the moment the cursor lands, not while it's still travelling.
  const flow1JanHover = phase === 'cursor1-travel' || phase === 'cursor1-click';
  const flow2JanHover = phase === 'cursor2-travel' || phase === 'cursor2-click';
  const JAN_HOVER_TRANSITION = 'r 0.12s ease-out 0.36s';
  ...
  // The wrapper sitting behind also gets an explicit shrink (on top of the
  // perspective scale) so the background flow reads as clearly smaller.
  const BACK_SCALE = 0.9;
  const flow1Scale = flow2OnTop ? BACK_SCALE : 1;
  const flow2Scale = flow2OnTop ? 1 : BACK_SCALE;
    ...
    >
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          transform: `${FLOW1_TRANSFORM} translateZ(${flow1Z}px) scale(${flow1Scale})`,
          transformOrigin: 'center',
          transformStyle: 'preserve-3d',
          transition: 'transform 1.65s cubic-bezier(0.65, 0, 0.35, 1)',
        }}
      >
        <PdrChartSmall sizePct={70} hoveredIndex={flow1JanHover ? 1 : undefined} hoverTransition={JAN_HOVER_TRANSITION} />
      ...
      <div
        style={{
          position: 'absolute',
          inset: 0,
          transform: `${FLOW2_TRANSFORM} translateZ(${flow2Z}px) scale(${flow2Scale})`,
          transformOrigin: 'center',
          transformStyle: 'preserve-3d',
          transition: 'transform 1.65s cubic-bezier(0.65, 0, 0.35, 1)',
        }}
      >
        <PdrPrrChartSmall sizePct={70} hoveredIndex={flow2JanHover ? 1 : undefined} hoverTransition={JAN_HOVER_TRANSITION} />
        <div
          style={{
            position: 'absolute',
            left: PANEL_LEFT,
